...
std::shared_ptr<Picture> PictureFactory::Create(std::wstring imagesDir)
{
    ...
    auto machine = make_shared<Actor>(L"Machine");
    auto machineDrawable = make_shared<MachineDrawable>(L"Machine", imagesDir,1);

    auto machine2 = make_shared<Actor>(L"Machine");
    auto machineDrawable2 = make_shared<MachineDrawable>(L"Machine", imagesDir,2);
