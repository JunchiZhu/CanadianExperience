...
//    parent->Bind(wxEVT_COMMAND_MENU_SELECTED, &ViewTimeline::OnSelectMachine, this, XRCID("EditSelectMachine"));
...
///**
// * Handle the select machine menu option
// * @param event The menu event
// */
//void ViewTimeline::OnSelectMachine(wxCommandEvent& event)
//{
//    GetPicture()->GetTimeline()->GetMachineDrawable()->ShowDigBox(this->GetParent());
//}
